...
namespace Serialization
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var jsonFilePath = @"D:\Revature\girard-code\Serialization\persons.json";
        ...
        public static List<Person> DeserializeXmlFromFile(string xmlFilePath, List<Person> data)
        {
